...
install_pterodactyl() {
	...
	php artisan p:user:make --email=$email --admin=1 --password=$password --username=admin --name-first=admin --name-last=admin
	php artisan p:location:make --short=Panel
	php artisan p:location:make --short=Free
	php artisan p:location:make --short=Paid
