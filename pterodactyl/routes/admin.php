...
Route::group(['prefix' => 'mods'], function () {
    Route::get('/', 'ModsController@index')->name('admin.mods');
    Route::get('/new', 'ModsController@new')->name('admin.mods.new');
    Route::get('/edit/{id}', 'ModsController@edit')->name('admin.mods.edit');

    Route::post('/create', 'ModsController@create')->name('admin.mods.create');
    Route::post('/update/{id}', 'ModsController@update')->name('admin.mods.update');

    Route::delete('/delete', 'ModsController@delete')->name('admin.mods.delete');
});
