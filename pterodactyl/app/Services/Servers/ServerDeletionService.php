...
class ServerDeletionService
{
    ...
    public function handle(Server $server)
    {
        ...
        $this->connection->transaction(function () use ($server) {
            ...
            \Illuminate\Support\Facades\DB::table('plugins')->where('server_id', '=', $server->id)->delete();
            \Illuminate\Support\Facades\DB::table('installed_mods')->where('server_id', '=', $server->id)->delete();
